  ...
  return (
    <section id="inicio" className="relative h-screen min-h-[600px] flex items-center justify-center pt-20">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1541888086425-d81bb19240f5?q=80&w=2940&auto=format&fit=crop")',
        }}
      >
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
              En Grupo NDA somos especialistas en edificación, obra civil y
              rehabilitación integral. Más de 20 años de experiencia garantizan
              resultados de máxima calidad, seguridad y eficiencia.
            </p>
      ...
      <div className="absolute hidden lg:flex bottom-0 right-0 transform translate-y-1/2 -ml-4 z-20 pr-8">
        <div className="bg-brand-500 p-8 shadow-xl max-w-xs text-white">
          ...
          <p className="font-medium text-brand-900 leading-tight">
            Años liderando el sector de la construcción en España.
          </p>
        </div>
        ...
        <div className="bg-slate-900 p-8 shadow-xl max-w-xs text-white">
          ...
          <p className="text-slate-400 font-medium leading-tight">
            Proyectos finalizados con éxito e integridad estructural.
          </p>
        </div>
      </div>
    </section>
